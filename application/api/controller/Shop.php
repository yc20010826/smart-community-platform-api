...
class Shop extends Api
{
    ...
    public function get_merchant_info(){
        ...
        $data = $this->model
            ...
            ->find();
        $data->visible(['id','category_id','mer_name','mer_avatar_image','mer_bg_image','mer_address','mer_phone','is_business','sales_daterange','distribution_mode','sales_scope','sales_volume','sales_amount','status','status_msg','createtime','mer_notice']);
