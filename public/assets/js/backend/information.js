            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'community.name', title: __('小区')},
                        {field: 'category.name', title: __('类型'),searchList: Config.category_list},
                        {field: 'user.nickname', title: __('发布者'), operate: 'LIKE'},
                        {field: 'title', title: __('Title'), operate: 'LIKE'},
                        {field: 'contact', title: __('Contact'), operate: 'LIKE'},
                        {field: 'status', title: __('Status'), searchList: {"0":__('Status 0'),"1":__('Status 1'),"2":__('Status 2'),"3":__('Status 3')}, formatter: Table.api.formatter.status},
                        {field: 'look_num', title: __('浏览量'), operate: 'BETWEEN', sortable:true, sortName:'look_num'},
